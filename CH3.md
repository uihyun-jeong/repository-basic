...
답: x' = [0, 1/L; -1/C, -1/RC] * x + [1/L, -1/L; 0, 1/RC] * v <br>  
...
(b) x' = [0, 1, 0; 0, 0, 1; -2, 23, -5] * x + [0; 0; 1] * r  
y = [2, 1, 0] * x가 된다.<br>  
...
(a)의 답은 x' = [0, 1, 0; 0, 0, 1; -48 -44 -12] * x + [0;0;1] * r,  
y(t) = [5, 8, 0] * x 이다.  
...
###P3.17 다음과 같은 상태변수 방정식으로 표현된 시스템이 있다.  x' = [1, 1, 1; 4, 3, 0; -2, 1, 10] * x + [0; 0; 4] * u(t)  
y = [1, 0, 0] * x, G(s) = Y(s) / U(s)를 구하라.  
이를 실행시키는 코드는 이와 같으며  
